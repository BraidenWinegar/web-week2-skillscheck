...
const faveColors = ['red', 'white', 'black']
...
const me = {
    firstName: 'Braiden',
    superHeroName: 'Silent Man',
    homeTown: 'Sandy',
    superPowers: ['not making a sound', ' glaring', ' walking off like nothing happened'],
...
function setColor(arr){
    ...
    for(let i = 0; i < arr.length; i++){ // could use 3 instead of arr.length but if something goes wrong this will throw less errors;
        if(arr[i] === 'blue'){
            arr[i] = '#4D4DFF'
        }
    }
...
//////////////////Step 6////////////////////
//Lastly, create a function called redactInfo that will take in an obj as a paramter. Let's imagine our super hero needs to go undercover and we need to remove all info about them. That is what this function will do. 
//Loop over the object and change each keys value to 'redacted'. Outside of the loop but still in the redactInfo function, run the function redacted() which is a function we created that will update the text on the screen.
